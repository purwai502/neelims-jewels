    ...
    <div style={{ maxWidth: "900px" }}>
        ...
        <div style={{ border: "1px solid var(--border-gold)", overflow: "hidden" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr", background: "var(--gold-subtle)", borderTop: "2px solid var(--border-gold)" }}>
            ...
            <div style={{ padding: "16px 20px" }}>
              <p style={{ fontFamily: "'Playfair Display', serif", fontSize: "22px", color: "var(--text-primary)", fontWeight: 700 }}>₹{fmt(finalPrice)}</p>
            </div>
          </div>
      ...
      <div style={{
        ...
        {[
          ...
          ...(isGold && !product.is_sold ? [{ label: "Gold Rate", value: `₹${fmt0(product.gold_rate_snapshot)}/g (today)` }] : []),
...
function CostRow({ label, sublabel, weight, rate, cost, notes, highlight }: {
  ...
  return (
    <div style={{
      ...
      <div style={{ padding: "11px 14px" }}>
        <p style={{ fontFamily: "'Playfair Display', serif", fontSize: "14px", color: "var(--text-primary)", fontWeight: highlight ? 700 : 400 }}>
          ₹{fmt(cost)}
        </p>
      </div>
    </div>
